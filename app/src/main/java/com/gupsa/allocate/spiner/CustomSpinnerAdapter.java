package com.gupsa.allocate.spiner;
...
public class CustomSpinnerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null)
            convertView = inflater.inflate(R.layout.activity_spiner_main, parent, false);
        if (list != null) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        if (convertView == null)
            convertView = inflater.inflate(R.layout.activity_spiner_second, parent, false);
        if (list != null) {
            text = list.get(position);
